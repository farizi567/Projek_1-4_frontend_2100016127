<template>
    <div id="resume" class="mt-32">
        <button class="flex items-center gap-3 border p-1 px-5 rounded-full">
            <Icon name="carbon:user-profile" />RESUME
        </button>
        <h1 class="text-[30px] xl:text-[35px] mt-10">Education & <span class="dark:text-[#2AE98D]">Experience</span></h1>
